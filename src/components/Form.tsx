...
const Form: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <label>
        Country of Birth:
        <input type="text" name="countryOfBirth" value={formData.countryOfBirth} onChange={handleChange} />
      </label>
      <label>
        Nationality:
      ...
      <label>
        ...
        <input type="text" name="travelDocument" value={formData.travelDocument} onChange={handleChange} />
      </label>
      <label>
      ...
      <label>
        ...
        <input type="text" name="placeOfStay" value={formData.placeOfStay} onChange={handleChange} />
      </label>
      <label>
        Surname, given name and personal identification number of the landlord/host:
